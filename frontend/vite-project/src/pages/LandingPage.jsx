  ...
  return (
    <div className='bg-white'>
      ...
      <div className='bg-white p-10 text-center'>
        ...
        <button className='mt-10 py-3 px-4 text-[20px] bg-blue-600 text-white cursor-pointer rounded-lg hover:px-5 hover:text-[24px]' onClick={()=>(navigate("/auth"))}>Get Started</button>
