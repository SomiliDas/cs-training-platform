...
function ProgressTracker() {
  ...
  useEffect(()=>{
    const fetchPending = async()=>{
      try{
        let p_res = await fetch(`https://flight-training-platform-backend-cors.onrender.com/submissions/user/pending`, {
          method: "GET",
          credentials:"include"
        })
        if(!p_res.ok){
    ...
    const fetchApproved = async()=>{
      try{
        let a_res = await fetch(`https://flight-training-platform-backend-cors.onrender.com/submissions/user/approved`, {
          method: "GET",
          credentials:"include"
        })
        if(!a_res.ok){
    ...
    const fetchRejected = async()=>{
      try{
        let r_res = await fetch(`https://flight-training-platform-backend-cors.onrender.com/submissions/user/rejected`, {
          method: "GET",
          credentials:"include"
        })
        if(!r_res.ok){
