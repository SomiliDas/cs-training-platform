...
function GetAllStudents() {
    ...
    useEffect(()=>{
        const getAllUsers = async()=>{
            try{
                const res = await fetch("https://flight-training-platform-backend-cors.onrender.com/users/admins/getUsers", {
                    method:"GET",
                    headers :{
    ...
    const handleDelete = async(id)=>{
        let res = await fetch(`https://flight-training-platform-backend-cors.onrender.com/users/admins/users/${id}`,{
            method : "DELETE",
            credentials : "include"
