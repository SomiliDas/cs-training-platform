...
export default function PendingApprovals() {
    ...
    const acceptHandler = async(studentId , taskId)=>{
        try{
            const res = await fetch(`https://flight-training-platform-backend.onrender.com/submissions/approve/${studentId}/${taskId}`, {
                method:"PUT",
                credentials:"include"
            })
            if(!res.ok){
    ...
    const rejectHandler = async(studentId, taskId)=>{
        try{
            const res = await fetch(`https://flight-training-platform-backend.onrender.com/submissions/reject/${studentId}/${taskId}`, {
                method: "PUT",
                credentials : "include"
            })
            if(!res.ok){
