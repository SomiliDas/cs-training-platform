...
export default function TasksDashboard() {
    ...
    try{
        if(isEditMode){
                ...
                let res = await fetch(`https://flight-training-platform-backend.onrender.com/tasks/update/${editTaskId}`, {
                            method:"PUT",
                            headers : {
                                "Content-Type" : "application/json"
                            },
            ...
            let res = await fetch(`https://flight-training-platform-backend.onrender.com/tasks/create/${progId}`, {
                method:"POST",
                headers:{
                    "Content-Type" : "application/json"
                },
    ...
    const handleDelete = async(id)=>{
        try{
            let res = await fetch(`https://flight-training-platform-backend.onrender.com/tasks/delete/${id}`,{
                method:"DELETE",
                headers : {
                    "Content-Type" : "application/json"
                },
        ...
        const handleUpdate = async(id)=>{
            try{
                let res = await fetch(`https://flight-training-platform-backend.onrender.com/tasks/${id}`,{
                    method:"GET",
                    headers : {
                        "Content-Type" : "application/json",
