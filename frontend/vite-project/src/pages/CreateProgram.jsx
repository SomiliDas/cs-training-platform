...
export default function CreateProgram() {
    ...
    let programHandler = async(e)=>{
        ...
        try{
            let res = await fetch("/api/programs/create", {
                method:"POST",
                body : formData,
                credentials : "include"
            })
    ...
    <div>
      ...
      <div className='bg-white px-20 mt-20 flex justify-center items-center'>
            <div className='flex justify-center ml-20 items-center w-[45%]'>
                <form className='shadow-2xl p-10 w-full' encType='multipart/form-data' onSubmit={programHandler} >
                    <div className='mb-7'>
                    ...
                    <input type='submit' value={"Create Program"} className='p-3 bg-blue-600 text-white rounded-lg font-bold block hover:underline cursor-pointer' />
                </form>
